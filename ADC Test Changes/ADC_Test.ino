/*
  Nothing fancy has changed here, just commented out the extra print files.
  All functions and variables we are not using have been removed.
  Increased the sample rate from 16 000Hz to 44 100Hz
*/
...
#define SAMPLE_RATE 44100                   // see below maximum values
...
void setup_ADC_single(void) {
  ...
  adc->setAveraging(aver); //Is there a chance this could be useful?
  adc->setResolution(res); //This is set to 16, but the Teensy datasheet speaks of us having 2 13-bit DACs
